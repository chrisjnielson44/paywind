...
const investing: { title: string; href: string; description: string }[] = [
  {
    ...
    href: "#",
    description:
    "Effortless investing using automated, algorithm-driven strategies"
  },
  {
    title: "IRAs and 401(k)",
    href: "#",
    description:
      "Guidance on retirement accounts for secure, long-term savings",
  },
  {
    title: "Portfolio Options",
    href: "#",
    description:
      "Diverse investment choices tailored to your financial objectives",
  },
  {
    title: "Crypto Investing",
    href: "#",
    description: "Strategies for incorporating cryptocurrencies into your portfolio",
  },
  {
    title: "Micro Investing",
    href: "#",
    description:
      "Invest with small amounts, including fractional shares, for steady growth",
  },
  {
    title: "Financial Tools",
    href: "#",
    description:
      "Essential tools for smarter, more effective investing",
  },
]

const about: { title: string; href: string; description: string }[] = [
  {
    title: "Our Investing Philosophy",
      ...
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          <Link href="/about" legacyBehavior passHref>
            <NavigationMenuLink className="group inline-flex h-10 w-max dark:bg-gray-900 dark:hover:bg-gray-800 items-center justify-center rounded-md bg-background px-4 py-2 text-lg font-semibold transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50">
              About
            </NavigationMenuLink>
          </Link>
        </NavigationMenuItem>
