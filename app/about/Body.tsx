    ...
    <main className="isolate pb-40 dark:bg-gray-900">
      ...
      <div className="relative isolate -z-10">
        ...
        <div className="overflow-hidden">
          <div className="mx-auto max-w-7xl px-4 pb-32 pt-36 sm:pt-60 lg:pt-32">
      ...
      {/* Content section */}
      <div className="mx-auto -mt-12 max-w-7xl px-4 sm:mt-0 lg:px-4 xl:-mt-8">
      ...
      {/* Values section */}
      <div className="mx-auto mt-32 max-w-7xl px-4 sm:mt-40 lg:px-4">
