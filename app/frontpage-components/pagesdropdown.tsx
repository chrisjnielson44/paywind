...
export function PagesDropDown() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-md font-semibold dark:bg-gray-900 dark:hover:bg-gray-800">Features</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        {/* <NavigationMenuItem>
          <NavigationMenuTrigger className="text-md font-semibold dark:bg-gray-900 dark:hover:bg-gray-800">Solutions</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[375px] ">
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-md font-semibold dark:bg-gray-900 dark:hover:bg-gray-800">About</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid w-[200px] gap-3 p-4 md:w-[500px] md:grid-cols-1 lg:w-[200px] text-right items-right">
              {about.map((component) => (
                <ListItem
                  key={component.title}
                  title={component.title}
