    ...
    return(
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 className="my-10 text-center text-3xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">
                You Are Signed Out</h2>
            <Link href="/" replace className="flex w-full justify-center rounded-md bg-red-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">
                Return to Home
            </Link>
        </div>
    </div>
