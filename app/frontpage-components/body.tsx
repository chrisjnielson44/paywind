...
export default function Body() {
    ...
    return (
        <main className="bg-white dark:bg-background">
            <section className="bg-white dark:bg-background pb-20">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <div className="flex items-center justify-center ">
                            <Link href="/demo-dashboard" className="w-full bg-black inline-flex items-center justify-center px-5 py-3 mr-3 text-lg font-bold text-center text-white rounded-lg hover:bg-gray-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900  hover:transition duration-300 ease-in-out dark:ring-2 dark:ring-white md:text-xl ">
                                Request a Demo
                            </Link>
            ...
            {/* <section>
                <div className="relative isolate overflow-hidden bg-white dark:bg-background">
