    ...
    return (
        <header className="bg-white dark:bg-gray-900">
            ...
            <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
                ...
                <Dialog.Panel className="dark:bg-gray-900 fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 dark:sm:ring-gray-600 sm:ring-gray-900/10">
