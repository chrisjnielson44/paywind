...
export function PagesDropDown() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-lg font-semibold dark:bg-background dark:hover:bg-zinc-800">Features</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
          <Link href="/features" legacyBehavior passHref>
            <NavigationMenuLink className="group inline-flex h-10 w-max dark:bg-background dark:hover:bg-zinc-800 items-center justify-center rounded-md bg-background px-4 py-2 text-lg font-semibold transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50">
              Integrations
            </NavigationMenuLink>
          </Link>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-lg font-semibold dark:bg-background dark:hover:bg-zinc-800">About</NavigationMenuTrigger>
          <NavigationMenuContent>
