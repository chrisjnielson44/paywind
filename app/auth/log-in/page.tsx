...
export default function CustomAuthenticator() {
  ...
  return (
    <main className='bg-white h-screen dark:bg-gray-900'>
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        {errorMessage && <p className="text-red-500 text-center">{errorMessage}</p>} {/* Display the error message here */}

        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
          {/* <div className='py-3'>
          <button onClick={handleGoogleSignIn} type="button" className="w-full text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
          ...
          {/* You can expand this with sign up logic */}
          <p className="mt-10 text-center text-sm text-gray-500 dark:text-white">
            Don&apos;t have an account?{' '}
            <Link href="/auth/sign-up" className="font-semibold leading-6 text-green-600 hover:text-green-500 hover:underline">
              Sign Up
            </Link>
          </p>
          <div className="mt-4">
