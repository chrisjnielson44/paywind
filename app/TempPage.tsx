...
export default function TempPage() {
    return (
        <BackgroundGradientAnimation className="z-10">
            <div className="relative isolate flex items-center gap-x-6 overflow-hidden  px-6 py-4 sm:px-3.5 sm:before:flex-1  z-20">

                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                    <p className="text-sm leading-6 text-gray-200">
                        <strong className="font-semibold text-white">Paywind is currently in development</strong>
                        <svg viewBox="0 0 2 2" className="mx-2 inline h-0.5 w-0.5 fill-white" aria-hidden="true">
                    ...
                    <a
                        ...
                        className="my-4 md:my-4 lg:my-0 flex-none rounded-full px-3.5 py-1 text-sm font-semibold shadow-sm  bg-white text-black hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
                    >
