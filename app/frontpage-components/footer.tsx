            ...
            <div className="mx-auto max-w-screen-xl">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.instagram.com/reminfanmedia/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="https://twitter.com/reminfanmedia" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-gray-900 dark:hover:text-white">
