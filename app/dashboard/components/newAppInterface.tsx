...
const navigation = [
    ...
    { name: 'Team', href: '/dashboard/crypto', icon: UsersIcon, current: false },
    ...
    return (
        <div>
                    ...
                    <div className="fixed inset-0 flex">
                        ...
                        >
                            <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                                ...
                                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-white dark:bg-gray-900 px-6 pb-4 ring-1 ring-white/10">
                                                    ...
                                                    {teams.map((team) => (
                                                        <li key={team.name}>
                                                            <a
                                                                ...
                                                                className={classNames(
                                                                    team.current
                                                                        ? 'dark:bg-gray-800 bg-gray- text-white'
            ...
            <div className="lg:pl-72">
                <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-500 bg-gray-900 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                        <form className="relative flex flex-1" action="#" method="GET">
                            ...
                            <input
                                id="search-field"
                                className="text-white bg-gray-900 block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm"
                                placeholder="Search..."
                                type="search"
                                name="search"
                            />
                                ...
                                <div>
                                    <Menu.Button className="-m-1.5 flex items-center p-1.5">
                                        ...
                                        <span className="hidden lg:flex lg:items-center">
                                            <span className="text-white ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">
                                                {userName}
                                            </span>
