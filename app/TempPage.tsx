...
export default function TempPage() {
    return (
        <BackgroundGradientAnimation className="z-10">
            <div className="relative isolate flex items-center gap-x-6 overflow-hidden  px-6 py-4 sm:px-3.5 sm:before:flex-1 border-b border-1 border-gray-100 dark:border-gray-700 z-20">
