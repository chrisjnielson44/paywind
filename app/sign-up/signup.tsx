...
export default function CustomSignUp() {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        if (!isPasswordValid(password)) {
            setErrorMessage('Password must contain at least 8 characters. Must include at least one lowercase, at least one Uppercase, at least one number (0-9) and at least one special character (!@#$%^&*)');
            return;
        }
