        ...
        <div>
            <div className="container relative hidden h-screen overflow-hidden  flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 bg-background">
                <div className="relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
                    ...
                    <LottieAnimation animationPath="/finance-animate.json"  style={{ width: 600, height: 600 }}/>
                    </div>
                    </div>
                    <div className="relative z-20 mt-auto">
                        <h1 className="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl text-white dark:text-white">
