...
export default function TempPage() {
    return (
        <main className="lg:h-screen bg-white dark:bg-gray-900" >
            <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-white dark:bg-gray-900 px-6 py-4 sm:px-3.5 sm:before:flex-1 border-b border-1 border-gray-100 dark:border-gray-700">

                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                    <p className="text-sm leading-6 text-gray-900 dark:text-gray-200">
                        <strong className="font-semibold text-black dark:text-white">Paywind is currently in development</strong>
                        <svg viewBox="0 0 2 2" className="mx-2 inline h-0.5 w-0.5 fill-current dark:fill-white" aria-hidden="true">
                    ...
                    <a
                        ...
                        className="flex-none rounded-full bg-gray-900 px-3.5 py-1 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 dark:bg-white dark:text-black dark:hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
                    >
            ...
            <div className="isolate pb-40 bg-white dark:bg-gray-900 h-screen">
                <div className="relative isolate -z-10">
                    <svg
                        className="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-gray-200 dark:stroke-gray-600 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
                        aria-hidden="true"
                    >
                        <defs>
                            <pattern
