            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-black border-gray dark:border-black">
                <div className="mx-auto max-w-screen-xl">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 PayWind. All Rights Reserved.
                        </span>
