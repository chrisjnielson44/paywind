            ...
            <section className="bg-white dark:bg-gray-900 pb-20">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-bold text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 bg-green-500 hover:transition duration-300 ease-in-out bg-green-500 ">
                            Sign Up
                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <div className="lg:pr-8 lg:pt-4">
                            <div className="lg:max-w-lg">
                                <h2 className="text-base text-2xl font-semibold leading-7 text-indigo-600 dark:text-white">Connect with Plaid API</h2>
                                ...
                                <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">Experience finance without boundaries. Using the trusted Plaid API, Paywind offers you a seamless connection to your bank, gathering all your financial data securely in one place. Enjoy peace of mind with an app that prioritizes both your convenience and security.</p>
            ...
            <section className="bg-white dark:bg-gray-900 py-24">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        ...
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Here at Paywind, we focus on areas where technology, innovation, and capital can make personal finance seamless, efficient, and growth-driven.</p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Plan, allocate, and optimize. Seamlessly track and adjust your spending to ensure you meet your financial goals every month with our intuitive budgeting tools.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Safeguard your financial data. With our advanced security protocols and permissions, rest assured that your financial details are kept confidential and secure.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Auto-categorize expenses, receive timely reminders, and more. Dive into an array of templates and tools designed to make personal finance a breeze.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Robust tools tailored for in-depth financial reviews, from monthly summaries to yearly financial retrospectives.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Experience personal finance in a beautifully designed, user-friendly environment that fosters effective money management.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Stay on top of your financial game. Our system offers adaptable and structured tools tailored for both comprehensive and individual account oversight.</p>
                        </div>
                    </div>
                </div>
            </section>
