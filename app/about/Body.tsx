  ...
  return (
    <main className="isolate pb-40 dark:bg-background">
      ...
      <div className="relative z-10">
        <svg
          className="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-zinc-400 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
          aria-hidden="true"
        >
          <defs>
            <pattern
        ...
        <div className="overflow-hidden">
          <div className="mx-auto max-w-7xl xl:max-w-screen-2xl px-4 pb-32 pt-36 sm:pt-60 lg:pt-32">
      ...
      {/* Content section */}
      <div className="mx-auto -mt-12 max-w-7xl xl:max-w-screen-2xl px-4 sm:mt-0 lg:px-4 xl:-mt-8">
      ...
      {/* Image section */}
      <div className="mt-32 sm:mt-40 xl:mx-auto  max-w-7xl xl:max-w-screen-2xl xl:px-8 flex items-center justify-center">
      ...
      {/* Values section */}
      <div className="mx-auto mt-32 max-w-7xl xl:max-w-screen-2xl px-4 sm:mt-40 lg:px-4">
