...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 mb-3 border-b border-gray-400 dark:border-black">
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-4 dark:bg-black">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <a href="/Log-In" className="text-white text-lg bg-black font-bold rounded-lg px-7 py-2 hover:bg-green-500 hover:text-white transition duration-300 ease-in-out dark:text-white bg-green-500 dark:lg:hover:bg-black ">Log In</a>
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-bold text-xl lg:flex-row lg:space-x-12 ">
                            {[
                                ...
                                { href: "/a", name: "About", className: "text-black border-b border-gray-100  lg:hover:bg-transparent lg:border-0 lg:hover:text-green-500 dark:text-white " },
                            ].map((link) => (
                                <li key={link.name}>
