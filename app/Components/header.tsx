...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50  border-b border-gray-400 dark:border-black">
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-4 dark:bg-black">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <a href="/Log-In" className="text-white text-lg bg-black font-bold rounded-lg px-5 py-1 hover:text-white transition duration-300 ease-in-out dark:text-white bg-black border-2 border-white hover:bg-green-500  ">Log In</a>
