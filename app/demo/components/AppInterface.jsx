            ...
            <div className="relative flex h-16 justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <Link
                    href="/demo/dashboard"
                    className={`link inline-flex items-center font-medium border-b-2 ${pathname === '/demo/dashboard' ? 'border-green-500 text-gray-900 dark:text-green-500' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-white dark:hover:text-gray-400'}`}>
                    Dashboard
                  </Link>
                  <Link
                    href="/demo/spending"
                  ...
                  <Link
                    href="/demo/crypto"
                    className={`link inline-flex items-center font-medium border-b-2 ${pathname === '/demo/crypto' ? 'border-green-500 text-gray-900 dark:text-green-500' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-white dark:hover:text-gray-400'}`}>
                    Crypto
                  </Link>
                  <Link
                    href="/demo/transfer"
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="relative rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none  dark:bg-gray-800 p-1 text-gray-400 dark:hover:text-white "
                >
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-900 dark:ring-1 dark:ring-white dark:ring-opacity-5 dark:shadow-gray-700 dark:shadow-md">
                      <div className="px-4 py-3">
                        ...
                        <p className="truncate text-sm font-medium text-gray-900 dark:text-gray-200">kermitfrog@paywind.io</p>
                      </div>
                      <Menu.Item>
                        <Link
                      ...
                      <Menu.Item>
                        <Link
                          href="/"
                          className={`block px-4 py-2 text-sm text-gray-700  hover:bg-gray-100 hover:text-gray-800 dark:text-gray-200 ${pathname === '/demo/signout' ? 'border-green-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}`}
                        >
                          Sign out
                        </Link>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 pb-3 pt-2">
              ...
              <Disclosure.Button
                as="a"
                href="/demo/dashboard"
                className={`block border-l-4 py-2 pl-3 pr-4 text-base font-medium ${pathname === '/demo/dashboard' ? 'bg-green-50 border-green-500 text-green-700' : 'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 dark:text-white'}`}>
                Dashboard
              </Disclosure.Button>
              <Disclosure.Button
                as="a"
